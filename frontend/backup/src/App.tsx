    ...
    <>
      ...
      <div className="main-content">
        <div className="speech-section">
          <div className="speech-recognition-placeholder">
            <h3>🎤 Speech Recognition</h3>
            <p>Voice commands will be processed through the browser extension</p>
            <button onClick={() => handleCommand('test command')}>
