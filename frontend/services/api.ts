...
// This file will handle communication between your frontend and the backend
...
class ApiService {
  ...
  initializeWebSocket(): Promise<void> {
    return new Promise((resolve, reject) => {
      try {
        const wsUrl = this.baseUrl.replace('http', 'ws') + '/ws/speech';
...
export type { SpeechCommand, CommandResult, AgenticResponse };
